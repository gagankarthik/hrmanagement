    ...
    <div className="space-y-6">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-purple-600 to-brand-600 p-6 text-white shadow-lg">
        ...
        <div className="relative flex items-center gap-5">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="font-display text-2xl font-bold truncate">{vendor.name}</h1>
            {vendor.address && (
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="surface p-6">
          <div className="mb-4 flex items-center gap-2">
            ...
            <h2 className="font-display text-base font-bold text-slate-900">Vendor Information</h2>
          </div>
        ...
        <div className="surface p-6">
          ...
          <div className="mt-4 border-t border-slate-100 pt-3 text-xs text-slate-500">
            {formatDate(vendor.createdAt)} — {formatDate(vendor.updatedAt)}
          </div>
        </div>
      </div>
      ...
      <div className="surface">
        ...
        <div className="border-t border-slate-100 px-5 py-3">
          <p className="text-xs text-slate-500">Showing {vendorEmployees.length} employees</p>
        </div>
      </div>
