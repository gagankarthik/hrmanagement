...
const ADD_OPTIONS: { label: string; href: string; icon: React.ElementType }[] = [
  ...
  { label: 'Add End Client', href: '/endclients/new', icon: Target },
  { label: 'Add Vendor', href: '/vendors/new', icon: Package },
  { label: 'Add Subcontractor', href: '/subcontractors/new', icon: UserRoundCheck },
];
...
function PartnersContent() {
  ...
  const selectTab = (id: TabId) => {
    ...
    router.replace(`/partners?tab=${id}`, { scroll: false });
  };
