...
function EndClientDetailPageContent() {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      toast.error('Failed to delete end client', friendlyError(err));
      setIsDeleting(false);
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link href={`/endclients/${endClient.id}/edit`} className="btn-primary">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-emerald-600 to-teal-600 p-6 text-white shadow-lg">
        ...
        <div className="relative flex items-center gap-5">
          <Avatar name={endClient.name} size="xl" />
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="surface p-6">
          ...
          <div className="mt-4 border-t border-slate-100 pt-3 text-xs text-slate-500">
            {formatDate(endClient.createdAt)} — {formatDate(endClient.updatedAt)}
          </div>
        </div>
      </div>
      ...
      <div className="surface">
        ...
        <div className="border-t border-slate-100 px-5 py-3">
          <p className="text-xs text-slate-500">Showing {endClientEmployees.length} employees</p>
        </div>
      </div>
