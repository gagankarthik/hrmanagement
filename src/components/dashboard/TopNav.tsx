          ...
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <div className="flex h-9 w-9 items-center justify-center">
                <i className="fa-solid fa-cubes text-2xl text-brand-600"></i>
              </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="relative">
                ...
                >
                  <div className="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-br from-brand-500 to-purple-600 text-sm font-semibold text-white">
