/**
 * Certificate of Insurance (COI) policy expiry rules — pure domain logic.
 *
 * Shared by the subcontractor detail page and the dashboard so the 60-day
 * warning window is computed identically everywhere. No framework imports.
 */
